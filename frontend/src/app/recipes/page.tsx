      ...
      <main id="main-content" className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <Button
              render={<Link href="/recipes/wines" />}
              variant="outline"
              className="border-border text-foreground hover:bg-muted active:scale-[0.97] transition-all text-sm sm:text-base h-9 sm:h-10 px-3 sm:px-4"
            >
            ...
            <Button
              ...
              className="bg-brand text-zinc-900 hover:bg-brand-hover active:scale-[0.97] transition-all text-sm sm:text-base h-9 sm:h-10 px-3 sm:px-4"
            >
